...
weights and biases of the model by a small amount until convergence (ideally on a global
minimum in the N-dimensional cost function space) is reached. In this way, a model
...
cost functions) as well as layers.
