...
$m$ examples in a batch is shown below.

% Binary cross entropy
\begin{equation}
	\begin{aligned}
		C & = \frac{1}{m} \sum_{i = 0}^{m-1} {C_{i}}                                                       \\
		  & = \frac{1}{m} \sum_{i = 0}^{m-1}{ y_{i} \ln{\hat{y}_{i}} + (1 - y_{i}) \ln{(1 - \hat{y}_{i})}}
	\end{aligned}
\end{equation}
...
\begin{equation}
	\frac{\partial C_i}{\partial a_{0}^{L}} = \frac{y}{a^{L}} - \frac{ 1 - y}{ 1 - a^{L} }
\end{equation}
